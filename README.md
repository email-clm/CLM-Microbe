...
He, L, Lai, C.T., Mayes, M.A., Murayama, S., Xu, X.F., (2021) Microbial seasonality promotes soil respiratory carbon emission in natural ecosystems: a modeling study. Global Change Biology. (In press). (Site-level model application to confirm microbial seasonality has sitmulation impacts on soil carbon emission)
