...
! keep this as backup
   ...
   rf_decomp_cascade(begc:endc,1:nlevdecomp,i_s1b) = 0._r8
   ...
   rf_decomp_cascade(begc:endc,1:nlevdecomp,i_s1f) = 0._r8
   ...
   rf_decomp_cascade(begc:endc,1:nlevdecomp,i_s2b) = 0._r8
   ...
   rf_decomp_cascade(begc:endc,1:nlevdecomp,i_s2f) = 0._r8
   ...
   rf_decomp_cascade(begc:endc,1:nlevdecomp,i_s3b) = 0._r8
   ...
   rf_decomp_cascade(begc:endc,1:nlevdecomp,i_s3f) = 0._r8
   ...
   rf_decomp_cascade(begc:endc,1:nlevdecomp,i_s4b) = 0._r8
   ...
   rf_decomp_cascade(begc:endc,1:nlevdecomp,i_s4f) = 0._r8
...
#ifdef MICROBE
   k_dom = -log(1.0_r8-0.014_r8)
   k_bacteria = -log(1.0_r8-0.07_r8)
   k_fungi = -log(1.0_r8-0.07_r8)
#endif
