...
! !USES:
  ...
  use clm_varpar   , only: ngases, ndecomp_pools
#if (defined VICHYDRO)
...
#ifdef MICROBE	! this will not be used in real microbe module
!  data (s_con(4,i),i=1,4) /1911_r8, -113.7_r8, 2.967_r8, -0.02943_r8/ ! H2
!  data (s_con(5,i),i=1,4) /1911_r8, -113.7_r8, 2.967_r8, -0.02943_r8/ ! NO
!  data (s_con(6,i),i=1,4) /1911_r8, -113.7_r8, 2.967_r8, -0.02943_r8/ ! N2O
!  data (s_con(7,i),i=1,4) /1911_r8, -113.7_r8, 2.967_r8, -0.02943_r8/ ! NH3
!  data (s_con(8,i),i=1,4) /1911_r8, -113.7_r8, 2.967_r8, -0.02943_r8/ ! N2
#endif
...
#ifdef MICROBE
!  data (d_con_w(4,i),i=1,3) /0.939_r8, 0.02671_r8, 0.0004095_r8/ ! H2
!  data (d_con_w(5,i),i=1,3) /0.939_r8, 0.02671_r8, 0.0004095_r8/ ! NO
!  data (d_con_w(6,i),i=1,3) /0.939_r8, 0.02671_r8, 0.0004095_r8/ ! N2O
!  data (d_con_w(7,i),i=1,3) /0.939_r8, 0.02671_r8, 0.0004095_r8/ ! NH3
!  data (d_con_w(8,i),i=1,3) /0.939_r8, 0.02671_r8, 0.0004095_r8/ ! N2

  real(r8) :: Fick_D_w(ngases)
  ! temperature dependence of diffusion coefficient is following S.M. Kirov Institute of Chemical Technology, Kazan, Translated from Inzhenerno-Finicheskii Zhuran, vol 17, no. 3, 530-534.
  ! http://link.springer.com/content/pdf/10.1007%2FBF00827828.pdf
  ! http://en.wikipedia.org/wiki/Mass_diffusivity; N2O from Tamimi et al., Diffusion Coefficients for Hydrogen Sulfide....., J. Chem. Eng. Data 1994, 39, 330-332.
  ! unit: cm2/s
  data Fick_D_w(1:ngases) /1.49e-5, 2.1e-5, 1.92e-5, 4.5e-5, 2.6e-5, 1.88e-5, 1.64e-5, 1.88e-5/ ! ch4, o2, co2, h2, no, n2o, nh3, n2 (unit: cm2/s)
#endif
...
#ifdef MICROBE
!  data (d_con_g(4,i),i=1,2) /0.1325_r8, 0.0009_r8/ ! H2
!  data (d_con_g(5,i),i=1,2) /0.1325_r8, 0.0009_r8/ ! NO
!  data (d_con_g(6,i),i=1,2) /0.1325_r8, 0.0009_r8/ ! N2O
!  data (d_con_g(7,i),i=1,2) /0.1325_r8, 0.0009_r8/ ! NH3
!  data (d_con_g(8,i),i=1,2) /0.1325_r8, 0.0009_r8/ ! N2

  real(r8) :: Henry_kHpc_w(ngases)
  real(r8) :: Henry_C_w(ngases)
  real(r8) :: MBC_k(ndecomp_pools)
  ! http://www.mpch-mainz.mpg.de/~sander/res/henry.html -d lnKh/d(1/T) (unit: L*atm/mol)
  ! KHpc(T) = kHPC(T0) exp (-C(1/T-1/T0))
  ! KHcp(T) = kHPC(T0) exp (C(1/T-1/T0))
  data Henry_kHpc_w(1:ngases) /714.29_r8, 769.23_r8, 29.4_r8, 1282.1_r8, 555.6_r8, 42.7_r8, 0.02_r8, 1538.5_r8/ ! ch4, o2, co2, h2, no, n2o, nh3, n2
  data Henry_C_w(1:ngases) /1600._r8, 1500._r8, 2400._r8, 500._r8, 1700._r8, 2600._r8, 4100._r8, 1300._r8/ ! ch4, o2, co2, h2, no, n2o, nh3, n2
  
  data MBC_k(1:ndecomp_pools) /72._r8, 72._r8, 72._r8, 72._r8, 72._r8, 72._r8, 72._r8, 72._r8, 0._r8, 0._r8, 0._r8/ ! litc
#endif
