...
#else
         !Root fraction is set to zero if T_j < 0 degC
...
#ifdef Q10WBMOD
     !Woods and Berry:  Q10 formulation
     real(r8) :: f3
     real(r8) :: slope
     real(r8) :: y1
     real(r8) :: y
...
#ifdef Q10WBMOD
     f3(ab,bc) = (1._r8/ab)*(1.8_r8*ab)**((bc-15._r8)/10._r8)
#endif
...
#ifdef Q10WBMOD
           !Modification:  If tc > tc_thresh:  use original f1
           !               otherwise - follow a tangent to f1@tc_thresh
           !  
           tc_thresh = 15._r8
           if (tc .gt. tc_thresh) then 
             act = act25 * f1(q10act,tc)
	   else
             act = act25 * f3(q10act,tc)
	   end if	 
#endif
